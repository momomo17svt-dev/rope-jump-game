...
import { ADMOB_IOS_INTERSTITIAL_ID, resolveAdMobUnitId } from '@/lib/adsConfig';

const INTERSTITIAL_ID = __DEV__
  ? TestIds.INTERSTITIAL
  : resolveAdMobUnitId(process.env.EXPO_PUBLIC_ADMOB_IOS_INTERSTITIAL_ID, ADMOB_IOS_INTERSTITIAL_ID);
